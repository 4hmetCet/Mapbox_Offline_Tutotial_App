...
public class TaskActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                ...
                mapboxMap.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
                    ...
                    public boolean onMapClick(@NonNull LatLng point) {
                        //final Icon icon_markerBearing = IconFactory.getInstance(TaskActivity.this).fromResource(R.drawable.markerbearing);
                        ...
                        Toast.makeText(TaskActivity.this, String.format("User clicked at: %s", point.toString()), Toast.LENGTH_LONG).show();
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        offlineManager = OfflineManager.getInstance(TaskActivity.this);
    ...
    @Override
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        TaskActivity.this.map = mapboxMap;
        map = mapboxMap;
...
// Set the component's render mode
                ...
                AlertDialog dialog = new AlertDialog.Builder(TaskActivity.this)
                        ...
                        .setPositiveButton(getString(R.string.navigate_positive_button), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(TaskActivity.this, items[regionSelected], Toast.LENGTH_LONG).show();
    ...
    public void NextActivity(View view){
        Intent i = new Intent(TaskActivity.this, BasicSymbolLayerActivity.class);
        startActivity(i);
    }
